...
function SubmitButton({
  ...
  return (
    <button
      className={clsx(
        "sm:my-3 my-0 w-auto items-center cursor-pointer justify-center rounded-xl border-white bg-neutral-900 hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100 px-12 py-4 text-sm font-bold tracking-wide text-white transition-all duration-200",
