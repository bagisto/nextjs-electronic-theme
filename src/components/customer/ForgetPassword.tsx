        ...
        >
          ...
          <div className="flex flex-col gap-y-3 md:gap-y-2">
            <Button
              ...
              type="submit"
            />
            <span className="px-1 mx-auto md:mx-0 font-archivo">
              Back to sign in?{" "}
              <Link className="text-neutral-900 dark:text-white underline hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors duration-200" href="/customer/login" aria-label="Go to sign in page">
                Sign In
              </Link>
            </span>
          </div>
