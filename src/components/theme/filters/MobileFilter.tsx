    ...
    <>
      <div className="flex flex-wrap gap-3">
        ...
        >
          ...
          <span className="font-archivo text-base tracking-wide">Filter</span>
        </Button>
      </div>
                    ...
                    {Array.from(searchParams.keys()).some(
                      (key) => key !== QUERY && key !== SORT
                        ...
                        <button
                          ...
                          className="text-sm font-medium underline underline-offset-4 text-neutral-600 dark:text-neutral-400 cursor-pointer"
                        >
                          Clear all filters
                        </button>
                      )}
