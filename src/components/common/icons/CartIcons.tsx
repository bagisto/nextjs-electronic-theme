...
export function EmptyCartIcon({ className = "w-16 h-16" }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function SpinnerIcon({ className = "animate-spin h-5 w-5" }: { className?: string }) {
  return (
...
export function SmallSpinnerIcon({ className = "w-3 h-3 border border-neutral-400 border-t-transparent rounded-full animate-spin" }: { className?: string }) {
