...
export default async function Footer() {
  ...
  return (
    <>
      ...
      {/* Main footer */}
      <footer className="bg-neutral-50 dark:bg-neutral-900/50 text-neutral-700 dark:text-neutral-300">
        {/* Desktop footer */}
        ...
        <div className="lg:hidden border-t border-neutral-200 dark:border-neutral-800">
          <div className="px-4 py-6">
              ...
              fallback={
                <div className="flex flex-col gap-2">
                  {Array(4).fill(0).map((_, i) => (
                    <div key={i} className="h-3 bg-neutral-200 dark:bg-neutral-800 rounded w-24 animate-pulse" />
                  ))}
                </div>
              }
            >
            ...
            {/* Copyright */}
            <div className="mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-700 text-xs text-neutral-400 dark:text-neutral-500 text-center">
              <p>
                &copy; {copyrightDate} {copyrightName}
                {copyrightName.length && !copyrightName.endsWith(".") ? "." : ""}{" "}
                All rights reserved.
              </p>
              <p className="mt-1">Powered by Bagisto</p>
            </div>
          </div>
        </div>
      </footer>
